...
```mermaid
graph TD
    client["💻 Jupyter Notebook / Python Script  aiokafka Producer / Consumer"]

    subgraph docker["🐳 Docker Network"]
        k1["kafka-1  node_id=1  broker + controller  EXTERNAL :9094"]
        k2["kafka-2  node_id=2  broker + controller  EXTERNAL :9094"]
        k3["kafka-3  node_id=3  broker + controller  EXTERNAL :9094"]
        k1 <-->|Raft| k2
        k2 <-->|Raft| k3
        k1 <-->|Raft| k3
    end

    client -->|"localhost:19094"| k1
    client -->|"localhost:29094"| k2
    client -->|"localhost:39094"| k3
```
